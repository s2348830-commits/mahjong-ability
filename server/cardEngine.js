    ...
    class CardEditor {
            ...
            this.container.innerHTML = `
                <div class="editor-layout" style="display: flex; gap: 20px; padding: 10px; background: #2c3e50; color: white;">
                    ...
                    <div class="workspace" style="flex: 1; background: #ecf0f1; color: #333; padding: 20px; position: relative;">
                        ...
                        <button id="btn-save-card" style="margin-top: 20px; padding: 10px 20px; background: #27ae60; color: white; border: none; cursor: pointer;">保存して装備する</button>
                    </div>
                </div>
            `;
        }
        ...
        bindEvents() {
            ...
            document.getElementById('btn-save-card').addEventListener('click', () => {
                ...
                // カスタムイベントを発火させ、client.js 側でサーバーへ送信させる
